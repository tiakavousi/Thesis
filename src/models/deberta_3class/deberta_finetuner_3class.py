...
class DeBERTaFineTuner3Class:
    """
    Fine-tuner for 3-class DeBERTa model.
    """
    def __init__(self):
        ...
        print(f"[INFO] Initializing DeBERTa 3-class fine-tuner with model: {model_name}")
        ...
        self.trainer = ModelTrainer(self.model, model_type="deberta", class_weights=class_weights)
    ...
    def evaluate_model(self, test_loader):
        ...
        model_name = CONFIG_3CLASS["models"]["deberta"]["pretrained_model_name"]
        report_name = "DeBERTa_3Class_Classifier"
