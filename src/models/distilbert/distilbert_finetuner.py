...
class DistilBERTFineTuner:
    """
    Fine-tuner specifically for DistilBERT model.
    """
    def __init__(self):
        """
        Initialize the DistilBERT fine-tuner with configuration.
        """
        ...
        # Initialize trainer
        self.trainer = ModelTrainer(self.model, model_type="distilbert")
        print("[INFO] ModelTrainer initialized.")

        logger.info(f"Initialized DistilBERTFineTuner with model '{model_name}'")
    ...
    def run(self):
        ...
        logger.info("Starting DistilBERT fine-tuning process.")
        ...
        logger.info("Completed DistilBERT fine-tuning process.")
    ...
    def evaluate_model(self, test_loader):
        ...
        model_name = CONFIG["models"]["distilbert"]["pretrained_model_name"]
        report_name = "DistilBERT_Classifier"
