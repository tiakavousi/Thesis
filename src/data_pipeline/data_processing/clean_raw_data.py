...
def clean_repo_data(repo):
    ...
    flagged_comments = comments[comments["is_bot_generated"] | comments["is_bot_trigger"]].copy()
    ...
    print(f"Removing {removed_flagged_count} bot-related comments (by user or trigger); {remaining_after_flag} comments remain.")
    ...
    comments = comments[~(comments["is_bot_generated"] | comments["is_bot_trigger"])]
